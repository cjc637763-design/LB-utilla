...
namespace LB.Models
{
    ...
    {
        /// <summary>
        /// There is no gamemode manager to rely on, this should only be used by the LB mod when preparing modded gamemodes or gamemodes using a unique gamemode manager.
        /// </summary>
        None,
        /// <summary>
