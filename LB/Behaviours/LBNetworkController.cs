...
namespace LB.Behaviours
{
    internal class LBNetworkController : MonoBehaviourPunCallbacks
    {
        public static LBNetworkController Instance { get; private set; }
        ...
        public override void OnEnable()
        {
            ...
            if (NetworkSystem.Instance is NetworkSystem netSys && netSys is NetworkSystemPUN && PhotonNetwork.NetworkingClient is LoadBalancingClient client)
            {
                ...
                // This ensures any relative members a part of LB are properly defined before anything else gets their values
